...
export default function BackgroundLinesDemo() {
  return (
    <BackgroundLines className="flex items-center justify-center w-full flex-col px-4 pt-40">
      ...
      Describe Your Vision. <br /> See It Become a Website.
      </h2>
      ...
      <ThreeDCardDemo head={" Create Stunning Web Pages "} subhead={"Construct beautiful sites effortlessly without writing a single line of code"} />
      <ThreeDCardDemo head={" Tweak Your Layout with Real-Time Editing "} subhead={"Zero coding required for a smooth design process"} />
      <ThreeDCardDemo head={" Export Your Source Code Instantly "} subhead={" Get all your project files at no cost "} />
      </div>
